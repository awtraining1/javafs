...
public class FarmerController {
    ...
    @ResponseBody
    public RedirectView addNewFarmer(String farmerName, int farmerAge, String email, float farmerExperience) {
        FarmerRepositry.farmerList.add(new Farmer(farmerName, farmerAge, email, farmerExperience));
    ...
    @ResponseBody
    public RedirectView addNewFarmer_V2( @Valid Farmer farmer) {
