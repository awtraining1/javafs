...
public class FarmerController_V2 {
    ...
    // Incomplete functionality. May be it will completed next week
    @GetMapping("/singlefarmer/{id}")
    @ResponseBody
    public Farmer farmer1(@PathVariable int id){ 
    	System.out.println(" AAAAA Inside /singlefarmer/{id} farmer1 method AAAAA ");
